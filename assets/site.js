...
(function () {
  ...
  css.textContent =
    '.udh-h{position:sticky;top:0;z-index:60;background:rgba(252,249,248,.96);backdrop-filter:blur(12px);border-bottom:1px solid #e5e2e1;font-family:"Hanken Grotesk",sans-serif}' +
    ...
    '.udh-f{background:#001c17;color:#cfd8d5;font-family:"Hanken Grotesk",sans-serif;font-size:14px}' +
    ...
    '.udh-toast{position:fixed;left:50%;bottom:24px;transform:translateX(-50%);background:#00332b;color:#fff;padding:12px 20px;border-radius:12px;font:500 14px "Hanken Grotesk",sans-serif;z-index:100;box-shadow:0 8px 24px rgba(0,0,0,.2)}' +
